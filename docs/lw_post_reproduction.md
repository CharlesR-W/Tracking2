...
`docs/lw_wip_post.md`. The committed JSON inputs are under
...
`artifacts/lw_post/prior_diagnostic_different_checkpoint/` use a different
checkpoint hash and are intentionally excluded.
